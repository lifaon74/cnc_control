...
const config = {
  ...defaultConfig,
  githubPage: 'lifaon74/cnc_control',
  packageName: '@lifaon/cnc_control',
  libName: 'cnc_control',
...
const tags = Object.entries({
  'lifaon74/cnc_control': config.githubPage,
  '@lifaon/cnc_control': config.packageName,
  'cnc_control': config.libName,
